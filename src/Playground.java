...
public class Playground {
    ...
    public Playground (String pathName){
        try{
            ...
            final Image imageDamageRock = ImageIO.read(new File("./img/damageRock.png"));
            ...
            final int imageDamageRockWidth = imageDamageRock.getWidth(null);
            final int imageDamageRockHeight = imageDamageRock.getHeight(null);
                ...
                for (byte element : line.getBytes(StandardCharsets.UTF_8)){
                    switch (element){
                        ...
                        case 'R' : environment.add(new SolidSprite(columnNumber*imageRockWidth,
                            ...
                            break;
                        case 'D' : environment.add(new SolidSprite(columnNumber*imageDamageRockWidth,
                                lineNumber*imageDamageRockHeight, imageDamageRock, imageDamageRockWidth, imageDamageRockHeight));
                            break;
                    }
                    columnNumber++;
                }
